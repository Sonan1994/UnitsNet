    ...
    public partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("es-ES_tradnl", typeof(AngleUnit), (int)AngleUnit.Degree, new string[]{"°", "grados"}),
                ...
                ("es-ES_tradnl", typeof(AngleUnit), (int)AngleUnit.Gradian, new string[]{"grad"}),
                ...
                ("es-ES_tradnl", typeof(AreaUnit), (int)AreaUnit.Are, new string[]{"un", "Ares", "are"}),
                ...
                ("es-ES_tradnl", typeof(LengthUnit), (int)LengthUnit.Mile, new string[]{"mi", "Leguas", "Legua"}),
