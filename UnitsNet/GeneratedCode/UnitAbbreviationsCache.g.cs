    ...
    public partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(AreaUnit), (int)AreaUnit.Hectare, new string[]{"ha", "hecktares", "hecktare"}),
                ...
                ("en-US", typeof(AreaUnit), (int)AreaUnit.SquareFoot, new string[]{"ft²", "ft2", "SF"}),
                ("ru-RU", typeof(AreaUnit), (int)AreaUnit.SquareFoot, new string[]{"фут²"}),
                ("en-US", typeof(AreaUnit), (int)AreaUnit.SquareInch, new string[]{"in²", "in2"}),
                ...
                ("en-US", typeof(VolumeUnit), (int)VolumeUnit.CubicFoot, new string[]{"ft³", "ft3", "CF"}),
                ...
                ("en-US", typeof(VolumeUnit), (int)VolumeUnit.CubicYard, new string[]{"yd³", "CY", "yard³"}),
